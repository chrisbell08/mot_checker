...
@section('content')
	<div class="modal fade lookup-modal" id="lookup-modal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title">New Vehicle Lookup</h2>
				</div>
				<div class="modal-body">
					@include('VehicleLookup.new')
				</div>
				<div class="modal-footer">
					<button type="button" class="btn__default--outline pull-left" data-dismiss="modal"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;Back</button>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2 class="modal-title">Full Lookup Details</h2>
				</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn__default--outline" data-dismiss="modal">Close</button>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
